        ...
        <div class="container">
            ...
            <div class="row">
                <div class="input-field col s12 m12 l12">
                    <input placeholder="" id="nome_prod" name="nome_prod" type="text" class="validate" autocomplete="off">
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                  ...
                  <select class="browser-default" name="categoria_prod" autocomplete="off">
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                  ...
                  <textarea id="textarea" class="materialize-textarea" name="obs_prod" autocomplete="off"></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col s12 m12 l12">
